...
#		print(ticker)
#		rev = LongTermDebt(ticker)
#		rev_v = rev.get_LongTermDebt_values(local_json)
#		print(rev_v)
...
#ltd = LongTermDebt('UNP')
#test = ltd.get_LongTermDebt_values(response.json())
...
#	except:
#		continue
#	ltd = LongTermDebt(sample_ticker)
#	test = ltd.get_LongTermDebt_values(response.json())
