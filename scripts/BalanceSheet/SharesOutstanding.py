...
#	tp = SharesOutstanding(ticker)
#	tpv = tp.get_SharesOutstanding_values(local_json)
#	print(tpv)
...
#so = SharesOutstanding(sample_ticker)
#test = so.get_SharesOutstanding_values(response.json())
